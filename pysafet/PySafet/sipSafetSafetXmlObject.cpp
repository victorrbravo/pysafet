...
{
    return (sip_Safet_qt_metacast && sip_Safet_qt_metacast(sipPySelf,sipType_SafetXmlObject,_clname)) ? this : SafetXmlObject::qt_metacast(_clname);
}
...
extern "C" {static PyObject *meth_SafetXmlObject_sender(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_sender(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_SafetXmlObject, &sipCpp))
        {
            QObject *sipRes = 0;
...
extern "C" {static PyObject *meth_SafetXmlObject_receivers(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_receivers(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BG", &sipSelf, sipType_SafetXmlObject, &sipCpp, &a0))
        {
            int sipRes = 0;
...
extern "C" {static PyObject *meth_SafetXmlObject_timerEvent(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_timerEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_SafetXmlObject, &sipCpp, sipType_QTimerEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
extern "C" {static PyObject *meth_SafetXmlObject_childEvent(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_childEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_SafetXmlObject, &sipCpp, sipType_QChildEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
extern "C" {static PyObject *meth_SafetXmlObject_customEvent(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_customEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_SafetXmlObject, &sipCpp, sipType_QEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
extern "C" {static PyObject *meth_SafetXmlObject_connectNotify(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_connectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_SafetXmlObject_disconnectNotify(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_disconnectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_SafetXmlObject_senderSignalIndex(PyObject *, PyObject *);}
static PyObject *meth_SafetXmlObject_senderSignalIndex(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
...
extern "C" {static void *init_SafetXmlObject(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_SafetXmlObject(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...
static PyMethodDef methods_SafetXmlObject[] = {
    {SIP_MLNAME_CAST(sipName_childEvent), meth_SafetXmlObject_childEvent, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_connectNotify), meth_SafetXmlObject_connectNotify, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_customEvent), meth_SafetXmlObject_customEvent, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_disconnectNotify), meth_SafetXmlObject_disconnectNotify, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_receivers), meth_SafetXmlObject_receivers, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_sender), meth_SafetXmlObject_sender, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_senderSignalIndex), meth_SafetXmlObject_senderSignalIndex, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_syncAttributes), meth_SafetXmlObject_syncAttributes, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_timerEvent), meth_SafetXmlObject_timerEvent, METH_VARARGS, NULL}
};
