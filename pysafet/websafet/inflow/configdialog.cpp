...
void ConfigDialog::startService() {
      qDebug("...ConfigDialog::startService...");
      if ( mw ) {           
           //mw->infoserver->start();
      }     
}
...
void ConfigDialog::createIcons()
{
    ...
    configButton->setIcon(QIcon(":/config.png"));
    configButton->setText(tr("General"));
    configButton->setTextAlignment(Qt::AlignHCenter);
    configButton->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);

    QListWidgetItem *updateButton = new QListWidgetItem(contentsWidget);
    updateButton->setIcon(QIcon(":/update.png"));
    updateButton->setText(tr("Firma Electrónica"));
    updateButton->setTextAlignment(Qt::AlignHCenter);
    updateButton->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);

    QListWidgetItem *queryButton = new QListWidgetItem(contentsWidget);
    queryButton->setIcon(QIcon(":/query.png"));
    queryButton->setText(tr("Interfaz Web"));
