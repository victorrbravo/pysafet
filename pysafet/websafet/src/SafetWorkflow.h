...
//        void setPorc(const QString& p) { _porc = p; }
        ...
        /**
         * @brief extractKeyForField extrae una clave de una lista de par�metros
         * @param key
         * @return
         */
        ...
        static QStringList calculateListSQL(const QString& currsql, const QString &info, const QString& otherinfo = QString(""));
private:
...
//	QList< QMap<QString,QSet<QString> > > dropkeys;
	 ...
	 */
        ...
        /*
         *  \brief Agrega la informaci�n de documentsource al grafo
         *
         */
...
private:
   ...
   /**
       ...
       */
         ...
         /**
          * @brief doDeleteNodeAndArcs Borrar los nodos inicial y final dependiendo de un valor de configuraci�n
          * @param code
          * @param showstart
          * @param showend
          * @return
