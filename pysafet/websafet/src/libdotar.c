...
int dotar(int argc, char *argv[])
{
	...
	int mode = 0;
        ...
        if ( argc < 5 ) {
            fprintf(stderr,"Parametros equivocados");
            return 0;
        }
        if ( strcmp(argv[3],"-x") == 0 ) {
            //fprintf(stderr,"*Modo extraccion");
            mode = MODE_EXTRACT;
        }
            ...
            fprintf(stderr,"Argumentos equivocados");
            return 0;
        }
	libtar_list_t *l;
