...
SERVER_URL        =  u"https://gestion.cenditel.gob.ve/intranet"
LOGIN_URL         =  u"https://gestion.cenditel.gob.ve/intranet/login"
TEMPLATES_PATH    =  u"/var/www/media/templates"
TEMPLATES_URL     =  u"https://gestion.cenditel.gob.ve/media/templates/"
HOMESAFET_PATH    =  u"/home/vbravo"
MEDIA_PATH        =  u"/var/www/media"
MEDIA_URL         =  u"https://gestion.cenditel.gob.ve/media"
...
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery-latest.js"></script> 
<!-- <script type="text/javascript" language="javascript" src="https://gestion.cenditel.gob.ve/media/js/DataTables/media/js/jquery.js"></script> -->
<script type="text/javascript" language="javascript" src="https://gestion.cenditel.gob.ve/media/js/DataTables/media/js/jquery.dataTables.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svg.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.debug.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svggraph.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svgplot.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svganim.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svgdom.js"></script>
<script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.svgfilter.js"></script>
<link type="text/css" href="https://gestion.cenditel.gob.ve/media/jquery.svg.css" rel="Stylesheet" />
<!--		<style type="text/css" title="currentStyle">
			@import "https://gestion.cenditel.gob.ve/media/js/DataTables/media/css/demo_page.css";
			@import "https://gestion.cenditel.gob.ve/media/js/DataTables/media/css/demo_table.css";
		</style> -->
...
$.post('https://gestion.cenditel.gob.ve/intranet/viewtable' ,{},
function(data) {
//alert(data);
var myjson = null;
...
SAFETLOGIN = u"""
<form action="https://gestion.cenditel.gob.ve/intranet/gologin" class="signin" method="post" enctype="multipart/form-data">
...
<td><input id="password" name="password" type="password" value="" /> <small><a href="https://gestion.cenditel.gob.ve/intranet/goresendpassword">¿Lo has olvidado?</a></small></td>
</tr>
<tr>
...
<form action="https://gestion.cenditel.gob.ve/intranet/goregister" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
SAFETREGISTER = u"""
<form action="https://gestion.cenditel.gob.ve/intranet/register" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
<form action="https://gestion.cenditel.gob.ve/intranet/changepassword" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
<th><label for="passwordone">Contraseña</label></th>
...
<form action="https://gestion.cenditel.gob.ve/intranet/resendpassword" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
SAFETGOLOGIN = u"""
     ...
     <a href="https://gestion.cenditel.gob.ve/intranet/login">
...
<head>
  ...
  <link rel="stylesheet" href="https://gestion.cenditel.gob.ve/media/main.css" type="text/css" />
  <link rel="stylesheet" href="https://gestion.cenditel.gob.ve/media/jquery.autocomplete.css" type="text/css" />
  <link rel="stylesheet" href="https://gestion.cenditel.gob.ve/media/main.css" type="text/css" />
  <link rel="stylesheet" href="https://gestion.cenditel.gob.ve/media/css/ui-lightness/jquery-ui-1.8.8.custom.css" type="text/css" />

  <script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.bgiframe.min.js"></script>
  <script type="text/javascript" src="https://gestion.cenditel.gob.ve/media/jquery.autocomplete.js"></script>
  <script>
  ...
  $("#inputform").autocomplete('https://gestion.cenditel.gob.ve/intranet/formcomplete', {
                width: 400,
                multiple: true,
                multipleSeparator: " ",
...
<div >Formulario </div>
<br/>
<form action="https://gestion.cenditel.gob.ve/intranet/1"
...
<script>
  $(document).ready(function(){
    ...
    var data = "Core Selectors Attributes Traversing Manipulation CSS Events Effects Ajax Utilities".split(" ");
  $("#inputform").autocomplete('https://gestion.cenditel.gob.ve/intranet/conscomplete', {
                width: 400,
                multiple: true,
                multipleSeparator: " ",
                formatItem: formatItem,
...
<form action="https://gestion.cenditel.gob.ve/intranet/2"
class="signin" method="post"  enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
